...
from web.utils import get_templated_text
from web.vars import USER_ROLES, PRIORITY, SAFE_VERDICTS, UNSAFE_VERDICTS, ASSOCIATION_TYPE
...
class TableTree:
    ...
    all_columns = ['role', 'author', 'date', 'status', 'unsafe'] + \
                  ...
                  ['problem', 'problem:total', 'resource', 'tag', 'tag:safe', 'tag:unsafe', 'identifier', 'parent_id',
                   'start_date', 'operator']
