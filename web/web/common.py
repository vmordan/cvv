...
DATABASES = {
    'default': json.load(open(os.path.join(BASE_DIR, 'web', 'db.json'), encoding='utf8')),
}
...
# CV core configuration parameters are moved to jobs/configuration.py

DEF_USER = {
    'dataformat': 'hum',  # See web.vars.DATAFORMAT for options
    'language': 'en',  # See web.vars.LANGUAGES for options
