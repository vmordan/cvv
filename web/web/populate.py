...
from web.utils import file_get_or_create, unique_id, BridgeException
from web.vars import USER_ROLES, JOB_ROLES, ROOT_REPORT
...
class Population:
    ...
    def __populate_tags(self):
        ...
        if num_of_new > 0:
            created_tags.append(ngettext_lazy(
